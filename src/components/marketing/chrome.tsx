...
import { SOCIAL_PROFILES } from "@/lib/marketing/site";
...
/* lucide-react dropped brand/logo marks some versions back — this version
   (1.32) ships neither LinkedIn nor Instagram, so these two are drawn inline
   instead of pulling in a second icon package for two glyphs. Standard,
   widely-published brand-mark paths (the same ones the simple-icons project
   uses), not traced by hand. */
          ...
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              <a
                ...
                aria-label="ApproveHR on LinkedIn"
                className="text-slate-muted transition-colors hover:text-slate"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="ApproveHR on Instagram"
                className="text-slate-muted transition-colors hover:text-slate"
              >
