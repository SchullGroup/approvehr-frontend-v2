...
export const LEAVE_REQUESTS: LeaveRequest[] = DEMO_ENABLED
  ? [
      ...
      },
      {
        ...
        days: 5,
        status: "declined",
        reason: "Still in probation",
        approverId: "p-01",
        requestedAt: "2026-08-05",
        decidedAt: "2026-08-07",
        decidedById: "p-01",
        decisionNote: "Still in probation: revisit after confirmation.",
      },
      {
        id: "lv-07",
        employeeId: "p-01",
...
export const GOALS: Goal[] = DEMO_ENABLED
  ? [
      ...
      },
      {
        id: "g-02",
        ownerId: "p-03",
        title: "Cut payroll run time to under 10 minutes",
        progress: 45,
        dueQuarter: "Q3 2026",
        parent: COMPANY_GOAL,
        status: "at_risk",
      ...
      },
      {
        id: "g-05",
        ownerId: "p-05",
        title: "Publish the employee handbook",
        progress: 100,
        dueQuarter: "Q2 2026",
        status: "done",
      },
      {
        id: "g-06",
        ownerId: "p-02",
        title: "Close month-end within 5 working days",
        progress: 30,
        dueQuarter: "Q3 2026",
        status: "off_track",
      },
  ...
  ? [
      {
        id: "t-01",
        ref: "HR-2841",
        subject: "Payslip missing for July",
        category: "Payroll",
        raisedById: "p-07",
        assignedToId: "p-05",
        status: "in_progress",
      ...
      },
      {
        id: "t-02",
        ref: "HR-2840",
        subject: "Cannot see my leave balance",
        category: "Leave",
        raisedById: "p-09",
        assignedToId: "p-06",
        status: "open",
      ...
      },
      {
        id: "t-03",
        ref: "HR-2838",
        subject: "Request confirmation letter for visa",
        category: "Records",
        raisedById: "p-03",
        assignedToId: "p-05",
        status: "waiting",
      ...
      },
      {
        id: "t-04",
        ref: "HR-2836",
        subject: "Pension PIN not on my record",
        category: "Records",
        raisedById: "p-09",
        assignedToId: null,
        status: "open",
...
export const KB_ARTICLES = DEMO_ENABLED
  ? [
      ...
      {
        id: "kb-3",
        title: "Changing your pension PFA",
        views: 173,
        category: "Payroll",
      },
      {
        id: "kb-4",
        title: "Requesting a confirmation letter",
        views: 96,
        category: "Records",
      },
    ]
...
const TEMPLATE: Omit<OnboardingTask, "done">[] = [
  ...
  {
    id: "o5",
    label: "Added to the payroll run",
    owner: "hr",
    dueOffsetDays: 0,
  },
  {
