  ...
  ? [
      {
        ...
        screeningQuestions: [
          {
            id: "q1",
            question: "Do you have the right to work in Nigeria?",
            knockout: true,
          },
          {
            id: "q2",
          ...
          {
            id: "q3",
            question: "Walk us through a service you designed and owned.",
            knockout: false,
          },
        ],
      ...
      },
      {
        ...
        screeningQuestions: [
          {
            id: "q1",
            question: "Have you filed PAYE returns with a state IRS?",
            knockout: true,
          },
          {
            id: "q2",
            question: "Largest payroll you have run, by headcount?",
            knockout: false,
          },
        ],
        activeStages: [...STAGE_IDS],
      },
      {
        ...
        screeningQuestions: [
          {
            id: "q1",
            question: "Share a link to your portfolio.",
            knockout: true,
          },
        ],
...
export const CANDIDATES: Candidate[] = DEMO_ENABLED
  ? [
      ...
      },
      {
        ...
        firstName: "Zainab",
        lastName: "Yusuf",
        email: "zainab.yusuf@mail.com",
        phone: "+234 806 222 0022",
        location: "Abuja, NG",
        currentTitle: "Senior Engineer",
        currentCompany: "Flutterwave",
        yearsExperience: 7,
        source: "referral",
        referredBy: "Chidi Nwosu",
        expectedSalary: 1_750_000,
        noticePeriodWeeks: 8,
        cvFileName: "zainab-yusuf-cv.pdf",
      },
      {
        id: "c-03",
        firstName: "Emeka",
        lastName: "Anyanwu",
        email: "emeka.anyanwu@mail.com",
        phone: "+234 701 333 0033",
        location: "Lagos, NG",
        currentTitle: "Software Engineer",
        currentCompany: "Interswitch",
        yearsExperience: 4,
        source: "careers_page",
        expectedSalary: 1_300_000,
        noticePeriodWeeks: 4,
        cvFileName: "emeka-anyanwu-cv.pdf",
      },
      {
        id: "c-04",
        firstName: "Halima",
        lastName: "Sani",
        email: "halima.sani@mail.com",
        phone: "+234 809 444 0044",
        location: "Kano, NG",
        currentTitle: "Backend Developer",
        currentCompany: "Kuda",
        yearsExperience: 5,
        source: "sourced",
        expectedSalary: 1_450_000,
        noticePeriodWeeks: 2,
        cvFileName: "halima-sani-cv.pdf",
      },
      {
        id: "c-05",
        firstName: "Oluwaseun",
        lastName: "Adeyemi",
        email: "seun.adeyemi@mail.com",
        phone: "+234 802 555 0055",
        location: "Ibadan, NG",
        currentTitle: "Platform Engineer",
        currentCompany: "Moniepoint",
        yearsExperience: 8,
        source: "agency",
        expectedSalary: 1_900_000,
        noticePeriodWeeks: 12,
        cvFileName: "oluwaseun-adeyemi-cv.pdf",
      },
      {
        id: "c-06",
        firstName: "Chiamaka",
        lastName: "Udo",
        email: "chiamaka.udo@mail.com",
        phone: "+234 805 666 0066",
        location: "Enugu, NG",
        ...
        noticePeriodWeeks: 2,
        cvFileName: "chiamaka-udo-cv.pdf",
      },
      {
        id: "c-07",
        firstName: "Babatunde",
        lastName: "Lawal",
        email: "babatunde.lawal@mail.com",
        phone: "+234 807 777 0077",
        location: "Lagos, NG",
        currentTitle: "Payroll Officer",
        currentCompany: "Dangote Group",
        yearsExperience: 5,
        source: "careers_page",
        expectedSalary: 780_000,
        noticePeriodWeeks: 4,
        cvFileName: "babatunde-lawal-cv.pdf",
      },
      {
        id: "c-08",
        firstName: "Grace",
        lastName: "Effiong",
        email: "grace.effiong@mail.com",
        phone: "+234 813 888 0088",
        location: "Port Harcourt, NG",
        currentTitle: "Payroll Analyst",
        currentCompany: "Shell NG",
        yearsExperience: 6,
        source: "referral",
        referredBy: "Tunde Bakare",
        expectedSalary: 850_000,
        noticePeriodWeeks: 6,
        cvFileName: "grace-effiong-cv.pdf",
      },
      {
        id: "c-09",
        firstName: "Musa",
        lastName: "Ibrahim",
        email: "musa.ibrahim@mail.com",
        phone: "+234 810 999 0099",
        location: "Abuja, NG",
        currentTitle: "Finance Associate",
        currentCompany: "Access Bank",
        yearsExperience: 3,
        source: "linkedin",
        expectedSalary: 700_000,
        noticePeriodWeeks: 4,
        cvFileName: "musa-ibrahim-cv.pdf",
      },
      {
        id: "c-10",
        firstName: "Temitope",
        lastName: "Ogundipe",
        email: "temi.ogundipe@mail.com",
        phone: "+234 814 121 0121",
        location: "Remote, NG",
        currentTitle: "Product Designer",
        currentCompany: "Cowrywise",
        yearsExperience: 5,
        source: "sourced",
        expectedSalary: 1_200_000,
        noticePeriodWeeks: 4,
        cvFileName: "temitope-ogundipe-cv.pdf",
      },
      {
        id: "c-11",
        firstName: "Aisha",
        ...
        phone: "+234 816 131 0131",
        location: "Lagos, NG",
        currentTitle: "Senior Designer",
        currentCompany: "Piggyvest",
        yearsExperience: 7,
        source: "referral",
        referredBy: "Ngozi Eze",
        expectedSalary: 1_350_000,
        noticePeriodWeeks: 8,
        cvFileName: "aisha-mohammed-cv.pdf",
      },
      {
        id: "c-12",
        firstName: "Daniel",
        lastName: "Okafor",
        email: "daniel.okafor@mail.com",
        phone: "+234 818 141 0141",
        location: "Lagos, NG",
        ...
        expectedSalary: 850_000,
        noticePeriodWeeks: 1,
        cvFileName: "daniel-okafor-cv.pdf",
      },
    ]
  : [];
...
export const APPLICATIONS: Application[] = DEMO_ENABLED
  ? [
      ...
      },
      {
        ...
        stageEnteredAt: "2026-08-15",
        rating: 5,
        offer: {
          grossMonthly: 1_750_000,
      ...
      },
      {
        ...
        stageEnteredAt: "2026-08-14",
        rating: 3,
        screeningAnswers: {
          q1: "Yes",
          q2: "4 weeks",
          q3: "Built the settlement service at Interswitch, owned it for two years.",
        },
      },
      {
        id: "app-04",
      ...
      },
      {
        ...
        stageEnteredAt: "2026-08-02",
        rating: 2,
        rejectionReason: "Below the experience bar for this role",
      },
      {
        id: "app-07",
      ...
      },
      {
        ...
        stageEnteredAt: "2026-08-16",
        rating: 5,
        offer: {
          grossMonthly: 860_000,
  ...
  ? [
      {
        ...
        scheduledFor: "2026-08-12T10:00:00+01:00",
        durationMins: 30,
        interviewerIds: ["p-06"],
        status: "completed",
      },
      {
        ...
        applicationId: "app-01",
        kind: "technical",
        scheduledFor: "2026-08-20T14:00:00+01:00",
        durationMins: 90,
        interviewerIds: ["p-05", "p-01"],
        status: "scheduled",
      },
      {
        id: "int-03",
        ...
        kind: "technical",
        scheduledFor: "2026-08-13T11:00:00+01:00",
        durationMins: 90,
        interviewerIds: ["p-05"],
        status: "completed",
      },
      {
        ...
        applicationId: "app-02",
        kind: "final",
        scheduledFor: "2026-08-15T15:00:00+01:00",
        durationMins: 45,
        interviewerIds: ["p-01"],
        status: "completed",
      },
      {
        ...
        kind: "panel",
        scheduledFor: "2026-08-19T09:30:00+01:00",
        durationMins: 60,
        interviewerIds: ["p-02", "p-03"],
        status: "scheduled",
      },
      {
        id: "int-06",
        ...
        kind: "technical",
        scheduledFor: "2026-08-21T13:00:00+01:00",
        durationMins: 60,
        interviewerIds: ["p-04"],
        status: "scheduled",
      },
  ...
  ? [
      {
        ...
        recommendation: "yes",
        notes:
          "Clear communicator. Genuinely interested in the payroll domain.",
      },
      {
        id: "sc-02",
        applicationId: "app-02",
...
export function stageCounts(requisitionId?: string): Record<StageId, number> {
  const counts = Object.fromEntries(STAGE_IDS.map((s) => [s, 0])) as Record<
    StageId,
    number
  >;
